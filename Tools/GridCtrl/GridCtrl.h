...
public:
	...
	void SetHScrollAlwaysVisible(BOOL bVisible)   { m_bShowAlwaysHScroll = bVisible;  }
	void SetVScrollAlwaysVisible(BOOL bVisible)   { m_bShowAlwaysVScroll = bVisible;  }
...
protected:
	...
	BOOL		m_bShowAlwaysHScroll;
	BOOL		m_bShowAlwaysVScroll;
