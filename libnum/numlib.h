...
#include "powell.h"		/* Powell and Conjugate Gradient multi dimentional minimiser */
#include "varmet.h"		/* Variable Metric multi dimentional minimiser */
#include "dhsx.h"		/* Downhill simplex multi dimentional minimiser */
//#include "randopt.h"	/* Random sample multivariate optimser */
...
#include "aatree.h"		/* Anderson balanced binary sorted tree */
